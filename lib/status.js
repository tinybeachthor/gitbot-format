module.exports = (checks, statusInfo) => {
  ...
  const failureGifs = [
    ...
    'https://media1.tenor.com/images/c36e7ac370a9eb7930d2476aab3d06c3/tenor.gif',
    ...
    'https://media1.tenor.com/images/f73db5669f1e64b9179c75ec7efdd659/tenor.gif',
    'https://media.giphy.com/media/112CeAWuyhQX1C/source.gif',
  ]
  failureGifs.getForSha = getForSha
    ...
    return checks.create({
      ...
      output: {
        ...
        images: [
          {
            alt: 'sad',
            image_url: failureGifs.getForSha(sha),
          },
        ],
