...
function handle(action: string, pr_info: types.PullRequestInfo, github: any, status: types.Checkrun) {
...
async function enqueue(action: string, pr_info: types.PullRequestInfoFull, github: any) {
